...
NOTE: This script is intentionally standalone — no relative imports.
      It loads tracer_standalone.py from the same directory via sys.path.
"""
import json
import os
import sys
...
# ---------------------------------------------------------------------------
# Make the injected directory importable so we can load tracer_standalone.py
...
from tracer_standalone import TraceRow, VariableTracer  # noqa: E402
